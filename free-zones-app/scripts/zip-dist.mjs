// Zip dist/ for cPanel upload. Produces free-zones-dist.zip in the project root.
...
const OUT = join(APP_ROOT, 'free-zones-dist.zip')
...
console.log(`Zipping dist/ → free-zones-dist.zip`)
