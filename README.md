...
- **Cross-reference links** — citations like "section 65A" or "sections 12, 13 and 14" in section text are clickable and jump within the app; citations to other laws are left as plain text.
