// Zip dist/ for cPanel upload. Produces free-zones-reg-dist.zip in the project root.
...
const OUT = join(APP_ROOT, 'free-zones-reg-dist.zip')
...
console.log(`Zipping dist/ → free-zones-reg-dist.zip`)
