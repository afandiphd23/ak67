    ...
    <div className="auth-gate-overlay">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">
          {lang === 'bm'
            ? 'Akses kepada teks peraturan kastam digital ini dikhaskan untuk pegawai Jabatan Kastam Diraja Malaysia yang diberi kuasa.'
            : 'Access to this digital regulations reader is restricted to authorized officers of the Royal Malaysian Customs Department.'}
        </p>
        <div>
