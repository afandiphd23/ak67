...
import { allSections, findSection, localized, sectionByNumber } from '../data'
...
/** Citation number, e.g. 42A — must end at a word boundary so "12A" in "12AB" doesn't match. */
...
/** Renders text with "section 42A"-style citations linked to their sections. */
...
function XrefPreview({
  ...
  const snippet = (loc.content[0]?.text ?? '').trim()
  return (
    <div
